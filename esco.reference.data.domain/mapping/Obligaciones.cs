...
namespace ESCO.Reference.Data.Model
{
    ...
    {
        public ObligacionesList data { get; set; }
        public int? totalCount { get; set; }
    }
    public class ObligacionesList : List<Obligacion> { }
    ...
    public class Obligacion
    {
        ...
        public ObligacionesFields fields { get; set; }
        public DateTime? updated { get; set; }
    }

    public class ObligacionesFields
    {
