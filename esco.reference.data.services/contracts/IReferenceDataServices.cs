...
namespace ESCO.Reference.Data.Services.Contracts
{
    ...
    public interface IReferenceDataServices
    {
        ...
        Task<ReferenceDatas> GetReferenceData(DateTime? date, string type = null, string schema = null, bool usa = false, bool a3 = false);        //Retorna la lista de instrumentos.
        Task<string> GetReferenceDataAsString(DateTime? date = null, string type = null, string schema = null, bool usa = false, bool a3 = false); //Retorna la lista de instrumentos como una cadena.
        #endregion
