...
namespace ESCO.Reference.Data.Services
{
    ...
    public class ReferenceDataServices : IReferenceDataServices
    {
        ...
        public async Task<ReferenceDatas> GetReferenceData(DateTime? date = null, string type = null, string schema = null, bool usa = false)
        {
            string cfg = (date != null) ? Url.FilterDated : null;
            return await GetAsReferenceData(GetUrl(cfg, type, schema, false, date, usa));
        }
        ...
        public async Task<string> GetReferenceDataAsString(DateTime? date = null, string type = null, string schema = null, bool usa = false) =>
